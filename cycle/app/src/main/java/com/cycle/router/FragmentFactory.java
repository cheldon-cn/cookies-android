package com.cycle.router;

import com.cycle.about.AboutFragment;
import com.cycle.about.FeedbackFragment;
import com.cycle.base.BaseFragment;
import com.cycle.data.AuthInfoManager;
import com.cycle.home.HomeFragment;
import com.cycle.login.LoginFragment;
import com.cycle.newtopic.NewTopicFragment;
import com.cycle.newtopic.SelectNodeFragment;
import com.cycle.nodescloud.NodesCloudFragment;
import com.cycle.notifications.NotificationsFragment;
import com.cycle.search.SearchFragment;
import com.cycle.settings.SettingsFragment;
import com.cycle.topicdetail.TopicDetailFragment;
import com.cycle.topicdetail.viewimage.ViewImageFragment;
import com.cycle.topiclist.TopicListFragment;
import com.cycle.userprofile.UserProfileFragment;
import com.cycle.userprofile.block.BlockedUserListFragment;
import com.cycle.userprofile.replies.ReplyListFragment;
...
public class FragmentFactory {
    ...
    private static final Pattern HOME_TOPIC_LIST_PATTERN = Pattern.compile("^https://www.cycle.com[/]?$");
    private static final Pattern TOPIC_DETAIL_PATTERN = Pattern.compile("^https://www.cycle.com/t/\\d+$");
    private static final Pattern NODES_CLOUD_PATTERN = Pattern.compile("^https://www.cycle.com/nodes$");
    private static final Pattern SELECT_NODE_PATTERN = Pattern.compile("^https://www.cycle.com/nodes $");
    private static final Pattern NODE_TOPIC_LIST_PATTERN = Pattern.compile("^https://www.cycle.com/node/[^/]+$");
    private static final Pattern LOGIN_PATTERN = Pattern.compile("^https://www.cycle.com/login$");
    private static final Pattern USER_PROFILE_PATTERN = Pattern.compile("^https://www.cycle.com/u/\\w+$");
    private static final Pattern USER_FAVORS_PATTERN = Pattern.compile("^https://www.cycle.com/u/\\w+/favorites$");
    private static final Pattern USER_TOPICS_PATTERN = Pattern.compile("^https://www.cycle.com/u/\\w+/topics$");
    private static final Pattern USER_REPLIES_PATTERN = Pattern.compile("^https://www.cycle.com/u/\\w+/replies$");
    private static final Pattern NEW_TOPIC_PATTERN = Pattern.compile("^https://www.cycle.com/t/create/\\w+$");
